function [Solution,data]=DYCORS(data_file,maxeval, Ntrials,PlotResult,NumberNewSamples)
%----------------********************************--------------------------
...
%
%--------------------------------------------------------------------------
% DYCORS - Unconstrained optimization using surrogate models.
% DYCORS attempts to solve problems of the form:
...
% 
%DYCORS.m is an optimization algorithm that uses a cubic RBF
%surrogate model. The implementation is based on the published paper:
%   R. G. Regis and C. A. Shoemaker. 
...
%   Engineering Optimization, Vol. 45, Issue 5, pp. 529-555, 2013
%This paper and this code should be referenced whenever they are used to 
%generate results for the user's own research. 
%
%Contributers to this matlab implementation are J. Mueller, and 
%C.A.Shoemaker. 
%
...
%% ------------------------ Optimization  ---------------------------------
%parameter settings
Data.Ncand= min(100*Data.dim,5000); % number of candidate points ºòÑ¡µãÊý
Data.phifunction = 'cubic'; % radial basis function type
Data.polynomial = 'linear'; % polynomial tail for cubic RBF

%optimization procedure
Solution=DYCORSrestartManager(Data,maxeval,...
