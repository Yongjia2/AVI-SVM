function Data = datainput_Ackley200
%----------------********************************--------------------------
...
Data.xlow=zeros(1,200); %lower variable bounds
Data.xup=ones(1,200); %upper variable bounds
Data.dim=200;    %problem dimension
%objective function
Data.objfunction=@(x)myfun(x);
end %function

function y=myfun(x)
xlow=-15*ones(1,200); %variable lower bounds
xup=30*ones(1,200); %variable upper bounds
n=length(xlow);
x=xlow + (xup-xlow).*x;
